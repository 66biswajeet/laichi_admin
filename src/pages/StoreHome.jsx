            ...
            <Link
              ...
              className={`inline-block w-full px-4 py-3 rounded-lg transition-all duration-200 whitespace-nowrap ${
                tabName === "home-settings" || location.search === ""
                  ? "bg-blue-500 text-white shadow-lg transform scale-105 dark:bg-blue-600"
                  : "bg-white text-slate-700 font-medium shadow-sm hover:shadow-md dark:bg-slate-700 dark:text-slate-200"
              } hover:text-white hover:bg-blue-600 focus:outline-none dark:hover:bg-blue-600`}
            >
            ...
            <Link
              ...
              className={`inline-block w-full py-3 px-4 rounded-lg transition-all duration-200 whitespace-nowrap ${
                tabName === "privacy-setting"
                  ? "bg-blue-600 text-white shadow-lg transform scale-105 dark:bg-blue-600"
                  : "bg-white text-gray-700 font-medium shadow-sm hover:shadow-md dark:bg-gray-700 dark:text-gray-200"
              } hover:text-white hover:bg-blue-700 focus:outline-none dark:hover:bg-blue-700`}
            >
              <span className="text-sm font-semibold font-serif">
                {t("PrivacyTCSetting")}
              </span>
            ...
            <div className="sm:container md:p-6 p-4 mx-auto bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg">
              <form onSubmit={handleSubmit(onSubmit)}>
                <HomePage
                  ...
                  setServiceMenuLink={setServiceMenuLink}
                  serviceMenuLink={serviceMenuLink}
                  setHelpMenuLink={setHelpMenuLink}
                  helpMenuLink={helpMenuLink}
                  serviceElements={serviceElements}
                  setServiceElements={setServiceElements}
                  helpElements={helpElements}
                  setHelpElements={setHelpElements}
                  handleAddServiceElement={handleAddServiceElement}
                  handleRemoveServiceElement={handleRemoveServiceElement}
                  handleServiceElementImageChange={
                    handleServiceElementImageChange
                  }
                  handleAddHelpElement={handleAddHelpElement}
                  handleRemoveHelpElement={handleRemoveHelpElement}
                  handleHelpElementImageChange={handleHelpElementImageChange}
                  ...
                  ctaHeroEnabled={ctaHeroEnabled}
                  setCtaHeroEnabled={setCtaHeroEnabled}
                  ctaHeroBgImage={ctaHeroBgImage}
                  setCtaHeroBgImage={setCtaHeroBgImage}
                  featuredCategoryImages={featuredCategoryImages}
                  setFeaturedCategoryImages={setFeaturedCategoryImages}
                  handleFeaturedCategoryImageChange={
                    handleFeaturedCategoryImageChange
                  }
                />
