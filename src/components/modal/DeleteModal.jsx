    ...
    <>
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        <ModalBody className="text-center custom-modal px-8 pt-6 pb-4">
          ...
          <h2 className="text-xl font-medium mb-2 text-slate-800 dark:text-slate-100">
        ...
        <ModalFooter className="justify-center">
          <Button
            className="w-full sm:w-auto hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-slate-200 dark:hover:border-slate-600 text-slate-700 dark:text-slate-300"
            layout="outline"
            onClick={closeModal}
          >
            {t("modalKeepBtn")}
