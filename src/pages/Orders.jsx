...
const Orders = () => {
  ...
  return (
    <>
      ...
      <AnimatedContent>
        <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 mb-5">
          <CardBody>
                ...
                <div>
                  {loadingExport ? (
                    ...
                    <button
                      ...
                      } flex items-center justify-center text-sm leading-5 h-12 w-full text-center transition-colors duration-150 font-medium px-6 py-2 rounded-lg text-white bg-blue-500 border border-transparent active:bg-blue-600 hover:bg-blue-600 shadow-sm hover:shadow-md `}
                    >
                      Download All Orders
              ...
              <div className="grid gap-4 lg:gap-6 xl:gap-6 lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 py-2">
                ...
                <div className="mt-2 md:mt-0 flex items-center xl:gap-x-4 gap-x-1 flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
                  <div className="w-full mx-1">
                    ...
                    <Button
                      type="submit"
                      className="h-12 w-full bg-blue-500 hover:bg-blue-600 rounded-lg shadow-sm hover:shadow-md"
                    >
                      Filter
                    </Button>
                  </div>
                  ...
                  <div className="w-full">
                    ...
                    <Button
                      ...
                      type="reset"
                      className="px-4 md:py-1 py-3 text-sm dark:bg-slate-700 bg-slate-100 border-slate-300 dark:border-slate-600"
                    >
      ...
      {data?.methodTotals?.length > 0 && (
        <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-t-lg rounded-0 mb-4">
          <CardBody>
            <div className="flex gap-1">
              {data?.methodTotals?.map((el, i) => (
                <div key={i + 1} className="dark:text-slate-300">
                  {el?.method && (
                    <>
