      ...
      <div className="flex">
        ...
        <div className="lg:flex-1 md:flex-1 mr-3  sm:flex-none">
          <button
            ...
            className="border flex justify-center items-center h-10 w-20 hover:text-blue-400  border-gray-300 dark:text-gray-300 cursor-pointer  py-2 hover:border-blue-400 rounded-md focus:outline-none"
          >
